...
namespace FluffyUnderware.Curvy.Generator.Modules
{
    ...
    public class BuildVolumeCaps : CGModule
    {
        ...
        Matrix4x4 getMatrix(CGVolume vol, int index, bool inverse)
        {
            if (inverse)
            {
        ...
        Vector3[] applyMatrix(Vector3[] vt, Matrix4x4 matrix, out Bounds bounds)
        {
        ...
        {
            Matrix4x4 m = getMatrix(vol, index, false);
